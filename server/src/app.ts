...
import { issueCreationShortcutRoutes } from "./routes/issue-creation-shortcuts.js";
...
export async function createApp(
  ...
  api.use(agentChannelRoutes(db));
  api.use(assetRoutes(db, opts.storageService));
  api.use(projectRoutes(db));
  api.use(issueRoutes(db, opts.storageService));
  api.use(issueCreationShortcutRoutes(db));

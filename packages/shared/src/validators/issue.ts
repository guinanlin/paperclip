import { z } from "zod";
import { ISSUE_EXPECTED_OUTPUT_TYPES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "../constants.js";
...
export const createIssueSchema = z.object({
  ...
  expectedOutputType: z.enum(ISSUE_EXPECTED_OUTPUT_TYPES).optional().nullable(),
...
export const summarizeIssueResponseSchema = z.object({
  summary: z.string(),
});

export type SummarizeIssueResponse = z.infer<typeof summarizeIssueResponseSchema>;
